...
const CommunityLeadership = () => (
  <section id="leadership" className="relative py-24 md:py-32">
    <div className="max-w-6xl mx-auto px-5 md:px-8">
      <SectionHeader num="04/" eyebrow="Community" title="Leading on campus." tagline="College roles where I managed people, budgets, and partnerships." />
      <div className="relative">
        ...
        <div className="space-y-8">
          {COMMUNITY_LEADERSHIP.map((exp, i) => (
